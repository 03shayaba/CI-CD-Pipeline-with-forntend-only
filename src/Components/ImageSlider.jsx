...
const ImageSlider = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto px-4 sm:px-8 py-8 overflow-hidden'>
            <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8'>
                <h1 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900'>My Latest Premium Videos</h1>
                <div className='bg-gradient-to-r from-pink-500 to-yellow-500 p-0.5 rounded-xl hover:brightness-110 transition'>
                    <button className='bg-white rounded-xl px-5 py-2 text-sm font-semibold text-red-500 hover:bg-transparent hover:text-white transition duration-300'>
                        View All Services
                    </button>
                </div>
            </div>
