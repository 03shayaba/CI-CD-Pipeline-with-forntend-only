  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <div className="w-full lg:w-4/6 space-y-8 ">
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 text-sm text-gray-600 mb-2">
                <p className='text-gray-600 text-sm font-bold'><span className="text-red-700">Written by:</span> Marry Biden</p>
                <p className='hover:text-red-700 cursor-pointer'>14/03/2024</p>
              </div>
              ...
              <div className='flex justify-between items-center mt-4'>
                <button className="flex items-center text-red-700 font-semibold bg-red-100 px-3 py-2 rounded-lg hover:bg-red-700 hover:text-white transition">
                  <FaArrowRightLong className="" />
                </button>
                <button className="group flex items-center text-gray-600 font-semibold hover:text-white hover:bg-red-700 px-3 py-2 rounded-lg transition">
      ...
      <div className='flex flex-wrap gap-3 mt-10 justify-center'>
        {["1", "2", "3", "4", "5", "6"].map((num) => (
          <button key={num} className='w-10 h-10 flex items-center justify-center text-white bg-red-700 rounded-full font-bold hover:bg-red-400 hover:text-black transition cursor-pointer'>
            {num}
          </button>
        ))}
      </div>
